...
TEST(BigNumsTest, Arithmetic)
{
	...
	/*EXPECT_THROW((Big_double<2,4>{1e-1000000000000} /
	   Big_double<2,4>{10000000000000e1000000000000000000000000000000000000000}), Arithmetic_carry_exception);*/
	// std::cout << (Big_double<2,4>{1e-1000000000000} /
	// Big_double<2,4>{10000000000000e1000000000000000000000000000000000000000}).str() << std::endl;
}

TEST(BigNumsTest, Utilities)
{
	BigDouble<2, 4> b{5}, p{2};
