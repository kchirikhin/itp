...
namespace itp {
    void Compressor::set_ts_params(Symbol_t, Symbol_t, size_t) {
        // DO NOTHING
    }
    ...
    size_t Zlib_compressor::operator ()(const unsigned char *data, size_t size, unsigned char **tmp_buffer,
      ...
      /*for (size_t i = 0; i < size; ++i) {
        ...
        // std::cout << data << " Zlib: " << dst_capacity << std::endl;
        return dst_capacity;
    }
    ...
    size_t Lca_compressor::operator ()(const unsigned char *data, size_t size, unsigned char **,
        ...
        // std::cout << "Lcacomp: " << result << std::endl;
        return result;
    }
    ...
    size_t Automation_compressor::operator ()(const unsigned char *data, size_t size,
        ...
        // std::cout << "Automation: " << final_result << std::endl;
        return final_result;
    }

    void Automation_compressor::set_ts_params(Symbol_t alphabet_min_symbol,
    ...
    void Compressors_pool::init_compressors_for_ts(Symbol_t min_symbol, Symbol_t max_symbol,
                                                   size_t n_sym_to_evaluate) {
