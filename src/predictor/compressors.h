...
namespace itp {
    ...
    public:
        ...
        virtual void set_ts_params(Symbol_t alphabet_min_symbol, Symbol_t alphabet_max_symbol,
    ...
    public:
        ...
        void set_ts_params(Symbol_t alphabet_min_symbol, Symbol_t alphabet_max_symbol,
                           size_t n_sym_to_evaluate) override;
    private:
        Prediction_automation_ptr automation;
    };
    ...
    public:
        ...
        void init_compressors_for_ts(Symbol_t, Symbol_t, size_t);
